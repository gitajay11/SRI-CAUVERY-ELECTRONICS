...
-- CreateEnum
CREATE TYPE "StaffRole" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'MANAGER', 'INVENTORY_MANAGER', 'ORDER_MANAGER', 'SUPPORT_STAFF');
...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'PROCESSING', 'READY_TO_SHIP', 'SHIPPED', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'RETURN_REQUESTED', 'RETURNED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'AUTHORIZED', 'PAID', 'FAILED', 'REFUNDED', 'PARTIALLY_REFUNDED', 'COD_PENDING');
...
-- CreateEnum
CREATE TYPE "ReturnStatus" AS ENUM ('REQUESTED', 'APPROVED', 'REJECTED', 'PICKUP_SCHEDULED', 'RECEIVED', 'REFUND_PENDING', 'REFUNDED', 'CLOSED');
...
-- CreateEnum
CREATE TYPE "StockReason" AS ENUM ('PURCHASE', 'SALE', 'MANUAL_ADJUSTMENT', 'CUSTOMER_RETURN', 'DAMAGED', 'LOST', 'CANCELLED_ORDER', 'STOCK_TAKE');

-- CreateEnum
CREATE TYPE "AdminNotificationType" AS ENUM ('NEW_ORDER', 'PAYMENT_FAILED', 'LOW_STOCK', 'OUT_OF_STOCK', 'RETURN_REQUESTED', 'REFUND_REQUESTED', 'NEW_CUSTOMER', 'NEW_REVIEW');

-- CreateEnum
CREATE TYPE "BannerPlacement" AS ENUM ('HERO', 'PROMO_STRIP', 'CATEGORY_FEATURE', 'ANNOUNCEMENT');
...
CREATE TABLE "PushSubscription" (
    ...
    "auth" TEXT NOT NULL,
    "topics" "AdminNotificationType"[] DEFAULT ARRAY[]::"AdminNotificationType"[],
    "userAgent" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "StoreSettings" (
    ...
    "nameEn" TEXT NOT NULL DEFAULT 'Tamizh Electronics',
    "nameTa" TEXT NOT NULL DEFAULT 'தமிழ் மின்னணுவியல்',
    "logoUrl" TEXT,
    "email" TEXT NOT NULL DEFAULT 'support@tamizhelectronics.in',
    "phone" TEXT NOT NULL DEFAULT '+91 98400 00000',
    "whatsapp" TEXT NOT NULL DEFAULT '919840000000',
    "addressLine1" TEXT NOT NULL DEFAULT '18/3, Bazaar Main Road',
    "addressLine2" TEXT NOT NULL DEFAULT 'Near Bus Stand',
    "city" TEXT NOT NULL DEFAULT 'Madurai',
    "district" TEXT NOT NULL DEFAULT 'Madurai',
    "state" TEXT NOT NULL DEFAULT 'Tamil Nadu',
    "pincode" TEXT NOT NULL DEFAULT '625001',
    "gstin" TEXT,
    "currency" TEXT NOT NULL DEFAULT 'INR',
    ...
    "cancellableStatuses" JSONB NOT NULL DEFAULT '["PENDING","CONFIRMED","PROCESSING"]',
    "emailNotificationsEnabled" BOOLEAN NOT NULL DEFAULT true,
    "pushNotificationsEnabled" BOOLEAN NOT NULL DEFAULT true,
    "lowStockNotifyThreshold" INTEGER NOT NULL DEFAULT 5,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "InventoryTransaction" ADD CONSTRAINT "InventoryTransaction_actorId_fkey" FOREIGN KEY ("actorId") REFERENCES "AdminUser"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "OrderNote" ADD CONSTRAINT "OrderNote_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "AdminUser"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ReturnRequest" ADD CONSTRAINT "ReturnRequest_handledById_fkey" FOREIGN KEY ("handledById") REFERENCES "AdminUser"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_moderatedById_fkey" FOREIGN KEY ("moderatedById") REFERENCES "AdminUser"("id") ON DELETE SET NULL ON UPDATE CASCADE;
